...
Citizen.CreateThread(function()
    while true do
        ...
        if dist <= 2.5 then
            isNearShop = true
            ESX.ShowHelpNotification("Use left ~r~ALT ~w~to interact")
...
Citizen.CreateThread(function()
    ...
    TriggerEvent('nh-context:sendMenu', {
        ...
        {
            id = 2,
            header = "Talk To The Dealer",
            txt = "Limited Stock",
            params = {
                event = "supreme_illegal:buy",
                args = {
...
RegisterNetEvent("supreme_illegal:buy")
AddEventHandler("supreme_illegal:buy", function()
AddShopsIllegalMenu()
end)
